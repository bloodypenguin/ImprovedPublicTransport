...
namespace ImprovedPublicTransport.Detour
{
    ...
    public class PassengerFerryAIDetour : FerryAI
    {
        ...
        [RedirectReverse]
        private static void LoadPassengers(PassengerFerryAI ai, ushort vehicleID, ref Vehicle data, ushort currentStop,
            ushort nextStop)
        {
        ...
        [RedirectReverse]
        private static void UnloadPassengers(PassengerFerryAI ai, ushort vehicleID, ref Vehicle data, ushort currentStop,
            ushort nextStop)
        {
