...
namespace ImprovedPublicTransport2.Detour
{
  ...
  public class PassengerPlaneAIDetour : AircraftAI
  {
    ...
    private bool ArriveAtTarget(ushort vehicleID, ref Vehicle data)
    {
      ...
      //end mod
      PassengerPlaneAIDetour.UnloadPassengers(data.Info.m_vehicleAI as PassengerPlaneAI, vehicleID, ref data, targetBuilding, nextStop);
      //begin mod(+): track stats 
      ...
      else
      {
        ...
        //end mod
        PassengerPlaneAIDetour.LoadPassengers(data.Info.m_vehicleAI as PassengerPlaneAI, vehicleID, ref data, targetBuilding, nextStop);
        //begin mod(+): track stats
