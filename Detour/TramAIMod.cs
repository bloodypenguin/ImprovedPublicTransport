  ...
  public class TramAIMod : TramAI
  {
    ...
    public new bool CanLeave(ushort vehicleID, ref Vehicle vehicleData)
    {
      ...
      private void UnloadPassengers(ushort vehicleID, ref Vehicle data, ushort currentStop, ushort nextStop)
      {
          ...
          ushort bufferStatus = TramAIMod.GetBufferStatus(vehicleID1, ref instance1.m_vehicles.m_buffer[(int)vehicleID1]);
          ...
          ushort num2 = (ushort)((uint)bufferStatus - (uint)TramAIMod.GetBufferStatus(vehicleID1, ref instance1.m_vehicles.m_buffer[(int)vehicleID1]));
      ...
      private static ushort GetBufferStatus(ushort vehicleID, ref Vehicle data)
      {
          ...
          if ((int)data.m_leadingVehicle == 0)
          {
              ...
              while ((int)trailingVehicle != 0)
              {
                  ...
                  {
                      ushort bufferStatus = TramAIMod.GetBufferStatus(trailingVehicle, ref instance.m_vehicles.m_buffer[(int)trailingVehicle]);
